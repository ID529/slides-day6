...
::: {.white-12-pt}
Dean Marengi \| Tuesday, January 20<sup>th</sup>, 2026
:::
...
::: {.larger}
````
![](https://i.redd.it/amvp629onu6e1.jpeg)

````
:::


![](https://i.redd.it/amvp629onu6e1.jpeg){.absolute height="50%" right=40% bottom="0%"}
...
## Example Report {.smaller}

Clone repo: <https://github.com/dmarengi/sample-rmd>
